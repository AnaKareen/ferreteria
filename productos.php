...
<body>
    <div id="header">
        <div class="container">
            <!-- Navbar ================================================== -->
            <div id="logoArea" class="navbar row">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <h3>Todos los productos <small class="pull-right"> <?php echo ($web->getCount() > 1) ? "Se encontraron " . $web->getCount() . " productos" : "Se encontró " . $web->getCount() . " producto" ?> </small></h3>
                    <hr class="soft">
                    <br class="clr" />
                        ...
                        <div class="tab-pane  active" id="blockView">
                            <ul class="thumbnails">
                                <?php foreach ($datos as $dato) : ?>
                                    <li class="span3">
                                        <div class="thumbnail">
                                            <a href="#"><img src="uploads/productos/<?php echo $dato['fotografia']; ?>" alt="" /></a>
                                            <div class="caption">
